...
You are the production line for a Roblox trading-card game. Your job: generate base card art for the Grand Roster (464 cards), following a locked template, and register each card. The design work is done — this is manufacturing. When uncertain, STOP and report rather than inventing.
...
- CLEANUP FLAG: `/mnt/agents/output/cards/base/soc-gt-1-leo-the-goat.png` carries a baked frame from early tests — regenerate frameless.
